                        ...
                        <tbody>
                            @foreach ($user as $item)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{ $item->nip }}</th>
                                    ...
                                    <td class="px-6 py-4 text-center"><a href="{{ route('edit.admin', $item->id) }}" class="font-medium text-blue-600 hover:underline">Edit</a> </td>
