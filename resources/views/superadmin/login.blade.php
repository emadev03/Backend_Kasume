...
<html lang="en">
  ...
  <body
    style="background-image: url(image/1-ori.jpeg)"
  ...
  >
    <div class="relative py-16 before:absolute before:inset-0 before:w-full before:h-[50%] before:bg-darkblue">
      <div
        class="container relative px-6 m-auto text-gray-500 md:px-12 xl:px-40"
      >
        <div class="m-auto space-y-8 md:w-8/12 lg:w-full">
          <div>
            <img
              ...
              loading="lazy"
              class="w-32 h-32 ml-10 lg:hidden"
          ...
          >
            <div class="lg:grid lg:grid-cols-2">
              ...
              <div class="p-6 sm:p-16">
                ...
                <div
                  class="mt-20 space-x-4 font-bold text-center text-gray-300 font-inter"
                >
