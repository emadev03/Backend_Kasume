            ...
            <div class="w-full h-full">
                ...
                <div class="w-full h-full border border-gray-200 shadow-lg bg-gray-50 rounded-xl">
                    ...
                    <div class="p-4 space-y-6 text-black capitalize font-nobile">
                        ...
                        <form action="{{ route('update.admin', $admin->id) }}" method="POST" x-data="{ password: '', password_confirm: '' }"
                            class="space-y-3 font-nobile">
                            @csrf
                            <div class="">
                                <label for="first_name" class="text-black">First Name</label>
                                <input type="text" name="first_name" id="first_name" placeholder="Almadhani"
                            ...
                            <div class="">
                                ...
                                <input type="text" name="last_name" id="last_name" placeholder="Kurnia"
                            ...
                            <div class="">
                                ...
                                <input type="email" name="email" id="email" placeholder="orangtampan@gmail.com"
                                    value="{{ $admin->email }}"
                                    class="block w-full px-4 py-3 text-gray-600 transition duration-300 bg-gray-100 border border-gray-300 rounded-md focus:ring-2 focus:ring-softblue focus:outline-none invalid:ring-2 invalid:ring-red-400" />
                                @error('email')
                                    <div class="text-sm text-red-600">{{ $message }}</div>
                            ...
                            <div>
                                ...
                                <input type="password" x-model="password_confirm" name="password_confirmation"
                                    ...
                                    <li class="flex items-center py-1">
                                        <div :class="{
                                            'bg-green-200 text-green-700': password == password_confirm && password
                                                .length > 0,
                                            'bg-red-200 text-red-700': password != password_confirm ||
                                                password.length == 0
                                        }"
                                        ...
                                        <span
                                            :class="{
                                                'text-green-700': password == password_confirm && password.length >
                                                    0,
                                                'text-red-700': password != password_confirm || password.length ==
                                                    0
                                            }"
                            ...
                            <button id="submitNurse" type="submit"
