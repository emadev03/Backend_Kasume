                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="{{ route('adminAddNewDevice') }}"
                                            class="block px-4 py-2 border-l-4 bg-slate-200 border-softgreen {{ ($title = 'Add New Device') ? 'active' : 'hover:bg-gray-100' }}">Add
                                            New Device</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('listDevice') }}"
                                            class="block px-4 py-2 {{ ($title = 'Connected Device') ? 'active' : 'hover:bg-gray-100' }}">List
                                            Device</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('listConnectedDevice') }}"
                                            class="block px-4 py-2 {{ ($title = 'Connected Device') ? 'active' : 'hover:bg-gray-100' }}">Connected
                                            Device</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('historyConnectedDevice') }}"
                                            class="block px-4 py-2 {{ ($title = 'Connected Device') ? 'active' : 'hover:bg-gray-100' }}">History
                            ...
                            <li class="border-l-4 border-softgreen">
                                <button id="dropdownRightButton" data-dropdown-toggle="dropdownRightNurses"
                                    ...
                                    <div href="/addAdmin" aria-label="Add Nurses"
                                        ...
                                        <span
                                            class="pt-2 -mr-1 font-medium font-nobile text-softgreen {{ ($title = 'Admin') ? 'active' : 'group-hover:text-cyan-600' }}">Nurses</span>
                                    </div>
                                    ...
                                    <div id="dropdownRightNurses" class="z-10 hidden bg-white rounded-lg shadow w-44">
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <a href="/addAdmin"
                                                    class="block px-4 py-2 border-l-4 bg-slate-200 border-softgreen {{ ($title = 'Admin') ? 'active' : 'hover:bg-gray-100' }}">Add
                                                    New Admin</a>
                                            </li>
                                            <li>
                                                <a href="/adminList"
                                                    class="block px-4 py-2 {{ ($title = 'Admin') ? 'active' : 'hover:bg-gray-100' }}">Admin
                                                    List</a>
                                            </li>
                                        </ul>
                                    </div>
