...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nobile:wght@400;500;700&family=Poppins:wght@400;500;600;700;800;900&display=swap"
    rel="stylesheet"/>
    ...
    <link rel="icon" href="image/mainLogo.png" type="image/gif" sizes="5x5" />
  </head>
  <body>
    <div class="">
      <aside
          ...
          <ul class="mt-8 space-y-4 font-sans tracking-wide">
            <li class="ml-1">
              ...
              >
                ...
                <span
                  class="pt-2 -mr-1 font-medium font-nobile text-slate-200 {{ ($title = "Dashboard") ? 'active' :'group-hover:text-slate-400'}}"
                  >Dashboard</span
                >
              </a>
            </li>
            <li class="ml-1">
              <button
                ...
                data-dropdown-toggle="dropdownRightDevices"
                data-dropdown-placement="right"
              >
                <div
                  href="/superAddNewDevice"
                  aria-label="Devices"
                  class="relative flex items-center px-4 py-3 space-x-4 group"
                >
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="w-9 h-9 text-slate-200 {{ ($title = "Device") ? 'active' :'group-hover:text-slate-400'}}"
                  >
                    <path
                  ...
                  <span
                    class="pt-2 -mr-1 font-medium font-nobile text-slate-200 {{ ($title = "Device") ? 'active' :'group-hover:text-slate-400'}}"
                    >Devices</span
                  >
                </div>

                <div
                  id="dropdownRightDevices"
                ...
                >
                  ...
                  >
                    <li>
                      <a
                        href="{{ route('adminAddNewDevice') }}"
                        class="block px-4 py-2 border-l-4 bg-slate-200 border-softgreen {{ ($title = "Add New Device") ? 'active' : 'hover:bg-gray-100'}}"
                        >Add New Device</a
                      >
                    </li>
                    <li>
                      <a
                        href="{{ route('listDevice') }}"
                        class="block px-4 py-2 {{ ($title = "Connected Device") ? 'active' : 'hover:bg-gray-100'}}"
                        >List Device</a
                      >
                    </li>
                    <li>
                      <a
                        href="{{ route('listConnectedDevice') }}"
                        class="block px-4 py-2 {{ ($title = "Connected Device") ? 'active' : 'hover:bg-gray-100'}}"
                        >Connected Device</a
                      >
                    </li>
                    <li>
                      <a
                        href="{{ route('historyConnectedDevice') }}"
                        class="block px-4 py-2 {{ ($title = "Connected Device") ? 'active' : 'hover:bg-gray-100'}}"
                        >History of Connected Device</a
                      >
                    </li>
                  </ul>
                </div>
            ...
            <li class="border-l-4 border-softgreen">
              <button
                id="dropdownRightButton"
                data-dropdown-toggle="dropdownRightNurses"
                data-dropdown-placement="right"
              >
                <div
                  href="/addAdmin"
                  aria-label="Add Nurses"
                  class="relative flex items-center px-4 py-3 space-x-4 transition duration-500 ease-in-out delay-150 group {{ ($title = "Admin") ? 'active' : 'hover:translate-x-1 hover:bg-white'}}"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                  ...
                  <span
                    class="pt-2 -mr-1 font-medium font-nobile text-softgreen {{ ($title = "Admin") ? 'active' :'group-hover:text-cyan-600'}}"
                    >Nurses</span
                  >
                </div>

                <div
                  id="dropdownRightNurses"
                  class="z-10 hidden bg-white rounded-lg shadow w-44"
                >
                  <ul
                    class="py-2 text-sm text-gray-700 dark:text-gray-200"
                  ...
                  >
                    <li>
                      <a
                        href="/addAdmin"
                        class="block px-4 py-2 border-l-4 bg-slate-200 border-softgreen {{ ($title = "Admin") ? 'active' :'hover:bg-gray-100'}}"
                        >Add New Admin</a
                      >
                    </li>
                    <li>
                      <a
                        href="/adminList"
                        class="block px-4 py-2 {{ ($title = "Admin") ? 'active' :'hover:bg-gray-100'}}"
                        >Admin List</a
                      >
                    </li>
                  </ul>
            ...
            <ul>
              <li class="border-l-4 border-softgreen">
                ...
                >
                  <svg
                    ...
                    width="40"
                    height="40"
                    class="fill-current text-softgreen group-hover:text-cyan-600"
                    viewBox="0 0 48 48"
                  >
                    <path
                      d="M39.5,43h-9c-1.381,0-2.5-1.119-2.5-2.5v-9c0-1.105-0.895-2-2-2h-4c-1.105,0-2,0.895-2,2v9c0,1.381-1.119,2.5-2.5,2.5h-9	C7.119,43,6,41.881,6,40.5V21.413c0-2.299,1.054-4.471,2.859-5.893L23.071,4.321c0.545-0.428,1.313-0.428,1.857,0L39.142,15.52	C40.947,16.942,42,19.113,42,21.411V40.5C42,41.881,40.881,43,39.5,43z"
                  ...
                  <span
                    class="pt-2 -mr-1 font-medium font-nobile text-softgreen group-hover:text-cyan-600"
                    >Dashboard</span
                  >
                </a>
              </li>
              ...
              >
                ...
                />
                  ...
                  <span
                    class="pt-2 -mr-1 font-medium font-nobile text-slate-200 group-hover:text-slate-400"
                    >Nurses</span
                  >
                </a>
              </li>
      ...
      <section
        class="ml-auto bg-darkblue lg:w-[75%] xl:w-[80%] 2xl:w-[85%] 2xl:h-full"
      >
          ...
          <div class="ml-auto lg:w-full">
            <div class="">
              <div class="px-5 pt-5 mx-auto lg:px-10">
                ...
                >
                  <p
                    class="pl-4 font-semibold text-left uppercase font-poppins lg:pt-4 pt-7"
                  >
                    ...
                    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
                      <div class="z-10 top-0 h-16 lg:pt-2.5">
                        ...
                        >
                          <div class="lg:hidden">
                            <button
                              class="flex items-center py-3 text-blue-600 navbar-burger"
                            >
                              <svg
                                class="absolute block w-8 h-8 mt-12 fill-current right-7"
                                viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg"
                              >
