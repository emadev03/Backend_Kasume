...
<div class="flex flex-wrap w-1/3 h-full mx-auto">
    <div class="w-full p-1">
        ...
        >
            ...
            >
            <p class="font-medium">Update Device</p>
            </div>
            <div
            class="p-4 space-y-6 text-black capitalize font-nobile"
            >
            <p class="mt-3 font-medium text-center">
                fill the update device information here:
            </p>

            <form action="{{ route('updateDevice', $device->code) }}" method="POST" class="space-y-2 font-nobile">
                @csrf
                <div class="">
