...
<body>
    <div style="background-image: url(image/1-ori.jpeg)"
        class="max-w-screen-4xl lg:h-screen m-0 border border-gray-100 rounded-md sm:bg-cover sm:bg-no-repeat">
        <div class="absolute inset-0 w-full h-[50%] bg-darkblue m-0"></div>
        <div class="relative flex flex-items justify-center py-[5%] m-0 px-[20%] h-full w-full">
            <div class="w-full h-full">
                <div class="flex justify-center items-center text-center flex-col">
                    <img src="image/mainLogo.png" loading="lazy" class="w-32 h-32 lg:hidden mb-2"
                        alt="Permata indah logo" />
                    <p class="text-xl text-white uppercase font-poppins lg:hidden mb-8">
                        Permata Indah Hospital
                    </p>
                </div>
                <div
                    class="rounded-xl border bg-opacity-50 backdrop-blur-sm bg-[#373737] shadow-xl h-full flex flex-wrap m-0">
                    <div class="w-[50%] h-[100%] rounded-lg lg:block overflow-hidden" hidden>
                        <img src="image/loginPoster1.png" class="object-cover h-full w-full lg:w-auto rounded-l-xl"
                            loading="lazy" alt="background Login" />
                    </div>
                    <div class="p-10 sm:p-20 lg:w-[50%]">
                        ...
                        <form action="/login" method="POST" class="space-y-4">
                            ...
                            <div class="flex flex-row h-10">
                                <a href="/" class="w-1/2 my-3 h-full text-[#000C66] font-nobile font-bold text-sm hover:text-white">Dashboard User</a>
